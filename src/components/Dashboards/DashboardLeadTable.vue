      ...
      <v-card elevation="10">
        <v-list-item>
          <v-list-item-content>
            ...
            <template>             
              <DashboardPerTeamMember v-if="$store.state.OpsDashboard_Total_Count == $store.state.TeamMember_Count" />
            </template>
          </v-list-item-content>
        </v-list-item>
      </v-card>
...
<script>
import DashboardPerTeamMember from '@/components/Dashboards/DashboardPerTeamMember.vue'
